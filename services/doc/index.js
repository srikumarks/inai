...
I.boot = async function (name, resid, query, headers, body) {
    ...
    I.post = async function (name, resid, query, headers, body) {
        ...
        if (doc.status >= 200 && doc.status < 300) {
            ...
            I.dom('doc/title', {sel: 'doc/card-title', op: 'set', body: "/doc/" + service});
            I.dom('doc/body', {sel: 'doc/card-body', op: 'set', body: html});
            I.dom('doc/markdown/h', {sel: '#doc h2', op: 'set', classes: "title is-2"});
   ...
   I.dom('doc/background', {op: 'set', tag: 'div', classes: 'modal-background', childOf: I._self});
   I.dom('doc/card', {op: 'set', tag: 'div', classes: 'modal-card', childOf: I._self});
   I.dom('doc/card-head', {op: 'set', tag: 'header', classes:'modal-card-head', childOf: 'doc/card'});
   I.dom('doc/card-title', {op: 'set', tag: 'p', classes:'modal-card-title', attrs: {id: 'doc-title'}, childOf: 'doc/card-head'});
   I.dom('doc/close', {op: 'set', tag: 'button', classes: 'delete', attrs: {'aria-label': 'close'}, childOf: 'doc/card-head'});
   I.dom('doc/card-body', {op: 'set', tag: 'section', classes: 'modal-card-body', attrs: {id: 'doc-body'}, childOf: 'doc/card'});
   I.dom('doc/close-event', {sel: 'doc/close', op: 'event', event: 'click', service: 'doc', verb: 'post', resid: '/close'});
