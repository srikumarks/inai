...
RequestSigner.prototype.prepareRequest = function () {
    ...
    if (
        headers[this.credentials.headers.date_uc] ||
        headers[this.credentials.headers.date_lc]
    ) {
        this.datetime =
            headers[this.credentials.headers.date_uc] ||
            headers[this.credentials.headers.date_lc];
...
RequestSigner.prototype.stringToSign = function () {
    ...
    var stringToSign = ["HmacSHA256", this.getDateTime(), canonicalHash].join(
        "\n"
    );
    return stringToSign;
};
...
RequestSigner.prototype.canonicalString = function () {
    ...
    pathStr = this.parsedUrl.pathname
        .split("/")
        .map(function (seg) {
